...
const (
	AuthService_Login_FullMethodName           = "/pixlcrashr.vsfv.v1.AuthService/Login"
	AuthService_GetLoginOptions_FullMethodName = "/pixlcrashr.vsfv.v1.AuthService/GetLoginOptions"
)
...
type AuthServiceClient interface {
	...
	GetLoginOptions(ctx context.Context, in *GetLoginOptionsRequest, opts ...grpc.CallOption) (*LoginOptions, error)
}
...
func (c *authServiceClient) GetLoginOptions(ctx context.Context, in *GetLoginOptionsRequest, opts ...grpc.CallOption) (*LoginOptions, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginOptions)
	err := c.cc.Invoke(ctx, AuthService_GetLoginOptions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// Reports which login methods are enabled (custom method, AIP-136).
	GetLoginOptions(context.Context, *GetLoginOptionsRequest) (*LoginOptions, error)
}
...
func (UnimplementedAuthServiceServer) GetLoginOptions(context.Context, *GetLoginOptionsRequest) (*LoginOptions, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pixlcrashr.vsfv.v1.AuthService",
	...
	Metadata: "pixlcrashr/vsfv/v1/auth.proto",
}
