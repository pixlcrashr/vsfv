...
type Account struct {
	...
	DisplayFullCode string `protobuf:"bytes,12,opt,name=display_full_code,json=displayFullCode,proto3" json:"display_full_code,omitempty"`
	...
	DisplayFullName string `protobuf:"bytes,13,opt,name=display_full_name,json=displayFullName,proto3" json:"display_full_name,omitempty"`
...
func (x *Account) GetDisplayFullCode() string {
	if x != nil {
		return x.DisplayFullCode
	}
	return ""
}

func (x *Account) GetDisplayFullName() string {
	if x != nil {
...
const file_pixlcrashr_vsfv_v1_account_proto_rawDesc = "" +
	"\n" +
	" pixlcrashr/vsfv/v1/account.proto\x12\x12pixlcrashr.vsfv.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/api/field_info.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb3\x05\n" +
	"\aAccount\x12\x17\n" +
	...
	"\fdisplay_code\x18\x05 \x01(\tB\x03\xe0A\x02R\vdisplayCode\x12/\n" +
	"\x11display_full_code\x18\f \x01(\tB\x03\xe0A\x03R\x0fdisplayFullCode\x12/\n" +
	"\x11display_full_name\x18\r \x01(\tB\x03\xe0A\x03R\x0fdisplayFullName\x124\n" +
